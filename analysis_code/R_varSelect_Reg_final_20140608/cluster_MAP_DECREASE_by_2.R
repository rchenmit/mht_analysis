...
actual_targets = as.data.frame(data_for_model_scaled$MAP_DECREASE_2)
...
print(table(subset(data_merged_with_cluster, select=c("cluster_id", "BLACK"))))
...
write.csv(df_mean_features_by_cluster[, names_cluster_features], file="cluster_MAP_DECREASE_2.csv")

save.image("cluster_MAP_DECREASE_2.RData")
